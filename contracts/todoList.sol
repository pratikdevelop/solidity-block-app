...
contract ToDoList {
    ...
    function getCtreatorData (address _address) public view returns (address , uint256, string memory ,bool) {
    ...
    function getCreatrors() external view  returns (address[] memory) {
        return creaters;
    }
